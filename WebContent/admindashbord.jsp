...
<html>
<head>
<title>Rohan Banking System</title>
     ...
     <!-- Navigation -->
        <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-nav navbar-right">
			    ...
			    <li class="dropdown">
	        		<a href="#" class="dropdown-toggle avatar" data-toggle="dropdown"><img src="#"><span class="badge">9</span></a>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="ManagerRagister.html"><i class="fa fa-flask nav_icon"></i>Add</a>
                         
                        </li>
                        <li>
                            <a href="ViewAll.jsp"><i class="fa fa-laptop nav_icon"></i>View<span class="fa arrow"></span></a>
     	...
     	<div class="col_3">
        		...
        		<div class="r3_counter_box">
                    ...
                    try{
                		...
                		String s="select count(id) from manager where roll=?";
                		...
                		%>
                			...
                			<h5><strong><%=rt.getInt(1)%></strong></h5>
                			<span>Inventary Manager</span>
                			<% 
